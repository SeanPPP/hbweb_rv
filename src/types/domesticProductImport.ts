...
export interface InputProductData {
  hbProductNo: string
  productName?: string
  englishProductName?: string
  domesticPrice?: number
...
export interface BatchDetectItem {
  inputData: InputProductData
  isNewProduct: boolean
  existingData?: ProductImportItem['matchedProduct']
  hasChanges: boolean
  changeList: string[]
  hasDuplicateInDatabase?: boolean
  duplicateProductCodes?: string[]
}

export interface BatchDetectResponse {
  success: boolean
  data: BatchDetectItem[]
  message?: string
}
